    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-blue-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className={cn("text-4xl md:text-6xl mb-4",lusitana.className)}>Welcome to Our Staffing Company</h1>
          <p className={cn("text-lg md:text-xl mb-8",lusitana.className)}>Your partner for temporary staffing solutions</p>
          <div className="flex justify-center">
            <button className="bg-white text-blue-500 py-2 px-8 rounded-full font-bold text-lg  hover:bg-blue-400 hover:text-white">Get Started</button>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white shadow-lg rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-4">Find Temporary Staff</h3>
              <p className="text-lg mb-4">Explore our pool of skilled temporary workers to fill your staffing needs.</p>
              <button className="bg-blue-500 text-white py-2 px-4 rounded-full font-bold text-lg hover:bg-blue-600">Explore Staff</button>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-4">Join Our Team</h3>
              <p className="text-lg mb-4">Browse available temporary positions and start your next opportunity.</p>
              <button className="bg-green-500 text-white py-2 px-4 rounded-full font-bold text-lg hover:bg-green-600">View Jobs</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-gray-900 text-white py-8 text-center">
        <p>&copy; 2024 Your Staffing Company. All rights reserved.</p>
      </footer>
    </div>
  );
}
